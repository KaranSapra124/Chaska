export const AboutUs = () => {
  return (
    <>
      <main className="container mx-auto my-8">
        <section className="mb-12">
          <h1 className="text-3xl font-bold text-center mb-6">About FoodGun</h1>
          <div className="flex flex-col md:flex-row items-center justify-center">
            <div className="md:w-1/2 md:mr-4 mb-4 md:mb-0">
              <img
                ...
                alt="FoodGun Restaurant"
                className="rounded-lg shadow-lg"
              />
            </div>
            <div className="md:w-1/2 ">
              <p className="text-lg leading-relaxed">
                FoodGun is a place where flavor meets tradition. Nestled in the
              ...
              <p className="text-lg leading-relaxed mt-4">
                At FoodGun, we're not just about serving food; we're about
        ...
        <section>
         ...
         <div className="flex md:flex-row justify-between items-center flex-row-reverse">
    <div className="md:w-1/2 md:mr-4 mb-4 md:mb-0">
        <img
    ...
    <div className="md:w-1/2">
        <p className="text-lg leading-relaxed">
            Our team at FoodGun is a passionate group of individuals who
        ...
        <p className="text-lg leading-relaxed mt-4">
            ...
            hospitality, making FoodGun not just a restaurant, but a
